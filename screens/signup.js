  ...
  render() {
    ...
    return (
      <Container style={{backgroundColor:'#141313'}}>
        ...
        <ImageBackground
          source={require('../assets/main.png')} resizeMode='cover' style={{ height: '100%', width: Dimensions.get('window').width }}>


          <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)', position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, alignItems: 'center' }}>

            <Text style={{ color: '#E50914', fontFamily: 'Roboto_medium', fontSize: 45, justifyContent: 'center', top: 40 }}>Hotv</Text>
          ...
          <FadeInView>
            ...
            <Button style={{alignSelf:'center', marginTop: 30, borderRadius: 20, padding: 80, backgroundColor:'#E50914'}}
            ...
            <Text style={{color:'#E50914', fontSize: 15, fontFamily: 'Roboto_medium', textDecorationLine:'underline'}}
